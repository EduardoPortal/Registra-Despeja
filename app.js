...
class Bd {
    ...
    recuperarTodosRegistros() {
        ...
        //recuperarr todas as depesas cadastradas
        for (let i = 1; i <= id; i++) {

            //recuperar a despesa
            let despesa = JSON.parse(localStorage.getItem(i))

            //existe a  possibilidade de haver indices que foram pulados/ null  pular os indice
            if (despesa === null) {
                continue
            }
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    //percorrer o Array despesa testando cada despesa
